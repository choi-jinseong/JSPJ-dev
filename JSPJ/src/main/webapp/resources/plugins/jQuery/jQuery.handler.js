...
*/
		...
		eleHtml[++h] = "<div class='modal-dialog' style=\"font-family: 'Arial',NanumGothic;  width:90%; border:none; top:30%; -webkit-border-radius:5px; -moz-border-radius:5px;\">";
